 ...
 * [ODKRepo.yml](ODKRepo.yml)
     * Determines how your purl.obolibrary.org/obo/ODKRepo/ redirects will be handled
     ...
     * Paste in the contents of [ODKRepo.yml](ODKRepo.yml)
 ...
 * [ODKRepo.md](ODKRepo.md)
     ...
     * Paste in the contents of [ODKRepo.md](ODKRepo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
